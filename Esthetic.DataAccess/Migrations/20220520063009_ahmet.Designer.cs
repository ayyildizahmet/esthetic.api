...
namespace Esthetic.DataAccess.Migrations
{
    ...
    [Migration("20220520063009_ahmet")]
    partial class ahmet
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MakeEat.Domain.Branch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MakeEat.Domain.Branch", b =>
                {
                    b.HasOne("MakeEat.Domain.Address", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MakeEat.Domain.Company", "Company")
                        .WithMany("Branches")
            ...
            modelBuilder.Entity("MakeEat.Domain.Company", b =>
                {
                    b.HasOne("MakeEat.Domain.Image", "Logo")
                        .WithMany()
